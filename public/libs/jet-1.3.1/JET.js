/* JET: version = 1.3.1, released date = 25/06/2014 */
...
JET = function () {
	...
	*******************************************************************/
	...
	api.loggingOptions = _u.setLogOptions;
	...
	********************************************************************/
	...
	var _getComponentProperties = function () {
		...
		data.push({ type: "xs:string", access: "ro", HelpURL: JET.HelpURL || "" });
	...
	**************************************************************/
	...
	var _initChromeDnD = function () {
		...
		top_window.setDragData = function (data) {
	...
	api.init = function (initObj) {
		...
		_initializeQueue.then(function () {
			...
			if (jsAsyncContainer || top_window.externalHost != null || ("registerWithJET" in top_window) || ("eikonLinkReady" in top_window)) {
				...
				if (top_window.external && "registerWithCCFContainer" in top_window.external) {
					co = top_window.external;
				}
