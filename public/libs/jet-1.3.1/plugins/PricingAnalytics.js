        ...
        return new function () {
            ...
            function calculatorUpdateReceived(subscription, ric, fields, index) {
                ...
                if (Object.keys(fields)[0].substring(0,8) == "PA_TRACS" && self.updateCallback != undefined) {
                    ...
                    var syncLetter = responseMessage.substring(0, 1);
                    var messageType = responseMessage.substring(1, 2);

                    // If it's a result of an old request, don't send.
                    if (syncLetter != String.fromCharCode(self.transactionLetterCode)) return;
                    extractMessageAndSend(messageType, responseMessage.substring(2));
                }
